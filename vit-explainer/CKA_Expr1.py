...
from CKA1 import save_results
from CKA1 import CKA
import torch
import timm
import json
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cka_save_path', type=str,
                        default='./outputs/cka1_info.json')
    parser.add_argument('--fig_save_path', type=str,
                        default='./outputs/cka1_info.png')
    ...
    save_results(fig_save_path, title, model1_name,
                 model2_name, hsic_matrix)
